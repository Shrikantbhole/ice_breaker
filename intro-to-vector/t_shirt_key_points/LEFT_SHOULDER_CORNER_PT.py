...
def LEFT_SHOULDER_CORNER_PT(border_contour, read_image, t_shirt_builder):
    ...
    for index, point in enumerate(reshaped_contour):
        if tuple(border_contour[index]) == coordinates:
            ...
            t_shirt_builder.LEFT_SHOULDER_CORNER_PT = t_shirt_builder.LEFT_SHOULDER_CORNER_PT._replace(
